...
mysql_query("UPDATE `leve_p` SET `nazev` = '$a' ,`text` = '".$_POST["obsah"]."' WHERE id = '$id'") or die(mysql_error());
...
echo "<p align='center'><a href='updateform1.php?id=$id'><span style='color: black;'>".$jazyk['admin_031']."</span></a></p>";
}
include '../zapati.php';
?>
