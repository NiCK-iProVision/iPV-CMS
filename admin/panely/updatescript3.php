...
mysql_query("UPDATE `prostr_p` SET `nazev` = '$a' ,`text` = '".$_POST["obsah"]."' WHERE id = '$id'") or die(mysql_error());
...
echo "<p align='center'><a href='updateform3.php?id=$id'><span style='color: black;'>".$jazyk['admin_031']."</span></a></p>";
}
include '../zapati.php';
?>
